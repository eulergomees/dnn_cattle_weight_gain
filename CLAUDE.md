...
- ✅ **DNN feita** (`dnn_gmd.ipynb`): grid search expandido (48 configs) → melhor **(64,32), dropout 0, lr 1e-2, BN=False, wd 1e-4**. **CV 10-fold: R² 0,665, MAE 0,032** (baseline 0,066). Teto real ~0,66–0,68 (N=155); expandir grid deu só ~+0,01. LOPO catastrófico (Elvis→Sonico R²≈−76). *(vs R²≈0,16 do antigo sintético.)*
