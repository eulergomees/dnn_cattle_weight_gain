...
\footnotesize Integra variáveis zootécnicas, \textbf{sanitárias}, climáticas e de manejo em um único modelo, com \textbf{dados de rotina} (sem câmeras/sensores) e classificação sem dados genômicos.
\end{block}
\end{frame}
